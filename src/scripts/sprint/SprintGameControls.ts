...
class SprintGameControls {
  ...
  constructor(className: string) {
    ...
    const wrongButton = createHTMLElement(
      'button',
      `${this.className}__button ${this.className}__wrong`,
      `${SprintGameText.wrong}`,
    );
    ...
    const rightButton = createHTMLElement(
      'button',
      `${this.className}__button ${this.className}__right`,
      `${SprintGameText.right}`,
    );
